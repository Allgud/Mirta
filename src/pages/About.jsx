  ...
  return (
    <Container>
      ...
      <Row>
        ...
        <p style={stylesStory}>Учился на курсе frontend-разработчик от KATA Academy. За время прохождение курса получил обширную практику. В рамках программы курса разрабатывал приложение на React с использованием классовых компонентов.</p>
        ...
        <p style={stylesStory}>На текущий момент принимаю участие в командной разработке приложения по поиску менторов. Работаем по спринтам, задачи ставятся в Trello</p>  
        ...
        <p style={stylesStory}>Знаком с системой контроля версий git</p>
        <p style={stylesStory}>Умею работать c REST API</p>
